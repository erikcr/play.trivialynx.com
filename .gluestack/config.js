...
var config = (() => {
  ...
  var Toast = (0, import_react134.createStyle)({
    px: "$4",
    py: "$3",
    borderRadius: "$sm",
    flexDirection: "row",
  ...
  var ToastDescription = (0, import_react135.createStyle)({
    color: "$textLight700",
    _dark: {
      color: "$textDark200"
    },
  ...
  var ToastTitle = (0, import_react136.createStyle)({
    fontWeight: "$medium",
    props: {
      size: "md"
    },
  ...
  var Tooltip = (0, import_react137.createStyle)({
    width: "$full",
    height: "$full"
  });
  ...
  var TooltipContent = (0, import_react138.createStyle)({
    ":initial": {
      opacity: 0,
      scale: 0.5
    },
  ...
  var TooltipText = (0, import_react139.createStyle)({
    color: "$red400",
    fontFamily: "$body",
    //@ts-ignore
    userSelect: "none"
  ...
  var VStack = (0, import_react140.createStyle)({
    flexDirection: "column",
    variants: {
      space: {
        "xs": {
  ...
  var View = (0, import_react141.createStyle)({});

  // node_modules/@gluestack-ui/config/build/gluestack-ui.config.js
  var gluestackUIConfig = (0, import_react142.createConfig)({
    aliases: {
      bg: "backgroundColor",
  ...
  var componentsConfig = (0, import_react142.createComponents)(theme_exports);
  var config = {
    ...gluestackUIConfig,
  ...
  // gluestack-ui.config.ts
  var import_themed = __require("./mock.js");
  var config2 = (0, import_themed.createConfig)({
    ...config,
    tokens: {
      ...config.tokens,
      colors: {
      ...
      borderWidths: {
        ...config.tokens.borderWidths,
        "20": 20,
        "50": 50
      },
      opacity: {
        ...config.tokens.opacity
      }
    },
